...
#icon section
Image_icon=PhotoImage(file="Images/task2.png")
...
noteImage=PhotoImage(file="Images/task2.png")
Label(root,image=noteImage,bg="#32405b").place(x=340,y=25)

heading=Label(root,text="Mohammed Waleed", font="arial 15 bold",fg="white",bg="#32405b")
